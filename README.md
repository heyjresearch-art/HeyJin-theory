...
### 7. Phase Directions after Unfolding and the Emergence of Discrete Charge Ratios
...
with normalized values **−1, −2/3, −1/3, 0, +1/3, +2/3, +1**. The current analysis distinguishes positional stability from complete directional cancellation: a shared closure may stabilize a composite while outer closed regions retain directional organization. Geometric multiplicity remains distinct from physical formation probability.
